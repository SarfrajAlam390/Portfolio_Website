...
const scriptURL = 'https://script.google.com/macros/s/AKfycbz3GNjzdcceZf8L8Njnk8Ucxu-crVXvmmQwbYJBfSYrTBu3UYtZzjFOPTAgOqueNE1Z/exec';
...
icon.onclick = function () {
    ...
    if (document.body.classList.contains("dark-theme")) {
        icon.src = "images1/sun.png";
    } else {
        icon.src = "images1/moon.png";
    }
};
